gpa_database = [], name_database = [], classes_database = [], school_database = [], password_database = [], f_note = [], s_note = [], t_note = [], fo_note = [], fi_note = [],
si_note = [], se_note = [], ei_note = [], ni_note = [], f_date = [], s_date = [], t_date = [], fo_date = [], fi_date = [], si_date = [], se_date = [], ei_date = [], ni_date = []
class Account:
    ...
    def set_info(gpa,name,school,password):
        while password not in password_database:
            student_name = name
            ...
            return True
        return False
    def sign_up(gpa,name,school,password):
        while Account.set_info(gpa,name,school,password) == True:
            return True
...
def executable_code():
    ...
    if sign_in_up == 1:
        ...
        print("")
        Account.sign_up(gpa,name,school,password)
    ...
    if sign_in_up == 2:
        ...
        if Account.sign_in(password) == True:
            if len(classes_database) == 0:
                ...
                print("11. Exit")
            if len(classes_database) > 0:
                print("1. ",classes_database[0])
                print("")
                print("2. ",classes_database[1])
                print("")
                print("3. ",classes_database[2])
                print("")
                print("4. ",classes_database[3])
                print("")
                print("5. ",classes_database[4])
                print("")
                print("6. ",classes_database[5])
                print("")
                print("7. ",classes_database[6])
                print("")
                print("8. ",classes_database[7])
                print("")
                print("9. ",classes_database[8])
                print("")
                print("10. Info")
                print("")
                print("11. Exit")
